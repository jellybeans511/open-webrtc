...
(async function main() {
  ...
  let videoHeight = Number(document.getElementById('video-height'));
  let videoWidth = Number(document.getElementById('video-width'));
  let videoRate = Number(document.getElementById('video-rate'));
